...
def get_amazon_data_books(num_books, ti):
    ...
    """ 
    key='book_data': The identifier for the data being stored.
    xcom_push: A method to store data that other tasks in the DAG can retrieve later.
    """
...
dag = DAG(
    ...
    description = "dags to fetch books from Amazon",
